 ...
 * generated in the pe.com.entel.soa.data.generico.entelgenericheader.v1 package.
...
public class ObjectFactory {
    ...
    private final static QName _HeaderRequest_QNAME =
        new QName("http://entel.com.pe/soa/data/generico/entelGenericHeader/v1/", "headerRequest");
    private final static QName _HeaderResponse_QNAME =
        new QName("http://entel.com.pe/soa/data/generico/entelGenericHeader/v1/", "headerResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: pe.com.entel.soa.data.generico.entelgenericheader.v1
     *
     */
     ...
     *
     */
    @XmlElementDecl(namespace = "http://entel.com.pe/soa/data/generico/entelGenericHeader/v1/", name = "headerRequest")
     ...
     *
     */
    @XmlElementDecl(namespace = "http://entel.com.pe/soa/data/generico/entelGenericHeader/v1/", name = "headerResponse")
