...
public class ActualizarSuscripcionService {
    ...
    private EjecucionActualizacion ejecucionActualizacion = new EjecucionActualizacion();
	private InsertErrorCancelacionStoreProcedure procedureError;

	public ActualizarSuscripcionService(String tokenUrl, String tokenMetodo, String limpiarCacheUrl,
	...
	public EjecucionActualizacion ejecutar(Suscripcion s) throws Exception {
		try {
			...
			ejecucionActualizacion.setCodrpta("0000");
			
		} catch (ApiManagementException e) {
			procedureError.run(e.getError(), s.getIdSuscripcion());
			ejecucionActualizacion.setCodrpta(e.getError().getCodigoError());
			ejecucionActualizacion.setDescripcionrpta(e.getError().getDescripcionError());
			logger.info("Actualizacion de suscripcion [ " + s.getIdSuscripcion() + " ] con FALLO: " + e.getError());
		}
		return ejecucionActualizacion;
	}
